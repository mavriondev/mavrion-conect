...
const navEntries: NavEntry[] = [
  { href: "/norion-app", icon: LayoutDashboard, label: "Dashboard", exact: true },
  { href: "/norion-app/operacoes", icon: KanbanSquare, label: "Operações", exact: false },
  {
    icon: FolderOpen,
    label: "Cadastros",
    children: [
      { href: "/norion-app/empresas", icon: Building2, label: "Empresas", exact: false },
      { href: "/norion-app/sdr", icon: Magnet, label: "SDR / Prospecção", exact: false },
    ],
  },
  {
    icon: Briefcase,
    label: "Fundos",
    children: [
      { href: "/norion-app/fundos-parceiros", icon: Handshake, label: "Fundos Parceiros", exact: false },
      { href: "/norion-app/consulta-fundos", icon: Landmark, label: "Consulta Fundos", exact: false },
    ],
  },
  { href: "/norion-app/portal-clientes", icon: Users, label: "Portal Clientes", exact: false },
  { href: "/norion-app/relatorio", icon: BarChart3, label: "Relatórios", exact: false },
];
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 h-16 bg-[#0f172a] border-b border-[#1e293b] shadow-md">
      <div className="h-full max-w-full px-4 flex items-center gap-4">
        <Link href="/norion-app" className="flex items-center gap-2 font-bold text-lg text-white shrink-0" data-testid="link-norion-brand">
